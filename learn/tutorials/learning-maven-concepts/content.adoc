...
Of course, after creating a new project, the next natural step is to import it into an IDE such as https://vaadin.com/learn/tutorials/import-maven-project-intellij-idea[IntelliJ IDEA], https://vaadin.com/learn/tutorials/import-maven-project-eclipse[Eclipse], or https://vaadin.com/learn/tutorials/import-maven-project-netbeans[NetBeans].
