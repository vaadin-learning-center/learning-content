:title: Spring Boot backend: database, JPA repositories, and services
:tags: Java, Spring 
:author: Vaadin
...
ifndef::print[]
image::https://website.vaadin.com/hubfs/gitpod.svg[Open in GitPod, an online IDE, link="https://gitpod.io/#https://github.com/vaadin-learning-center/crm-tutorial/tree/02-components-and-layouts"]
