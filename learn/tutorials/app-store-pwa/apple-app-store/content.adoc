...
:linkattrs:
:imagesdir: ./images
:og_image: app-store--featured-image.png
...
+
image::app-store-connect-dashboard.png[App Store Connect dashboard view]
+
...
. Select *Distriute App*.
+
image::xcode-archive-view.png[Xcode organizer view]
+
. Select *App Store Connect* and click *Next*.
. Select *Upload* and click *Next*.
+
image::xcode-distribution-panel-view.png[xcode distribution panel]
+
