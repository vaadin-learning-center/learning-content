...
In the link:/tutorials/learn-pwa/turn-website-into-a-pwa[previous tutorial], the focus was on learning the basic principles of how Progressive Web Apps work. Some of the issues we identified with the application were:
