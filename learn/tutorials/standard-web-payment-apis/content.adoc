...
The add-on mentioned above is based on a community-driven https://github.com/jorgecasar/payment-request[web component]. Check out https://vaadin.com/tutorials/web-component-for-vaadin-flow[the steps] needed to create this add-on.
