...
Next, we'll need to make the changes we make in the form to presist.
...
First, let's make the Save, Delete and Close buttons work in the contact form. To add functionality to the buttons, we'll need to make them available in the ContactForm class.

. Open contact-form in Designer
. Give the three buttons id's "save", "delete", and "close", and connect them using the outline.
...
Add the following changes to MainView to handle the events:
...
Now, the functionality of the application is ready.
