...
* https://vaadin.com/docs/v14/tools/designer/getting-started/designer-setting-up-your-environment/intellij[Installing Vaadin Designer in IntelliJ IDEA].
* https://vaadin.com/docs/v14/tools/designer/getting-started/designer-setting-up-your-environment/eclipse[Installing Vaadin Designer in Eclipse].
