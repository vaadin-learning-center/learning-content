...
:author: 
:publish_date: 
:description: Introduction to Web app development in Java
:repo: https://github.com/vaadin-learning-center/java-web-tutorial
:linkattrs: // enable link attributes, like opening in a new window
:imagesdir: ./images

== Introduction

Welcome to Web App Development in Java: A practical guide. 
...
You can find the full source code for this guide on https://github.com/vaadin-learning-center/vaadin-crm-tutorial[GitHub].
