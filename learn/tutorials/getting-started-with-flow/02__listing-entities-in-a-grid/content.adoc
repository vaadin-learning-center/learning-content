...
* https://raw.githubusercontent.com/vaadin/tutorial/vaadin10%2B/src/main/java/org/vaadin/example/Customer.java[Customer.java^]: This this is the main domain object, a basic Java bean that encapsulates data about a customer.
