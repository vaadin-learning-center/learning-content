...
If you have the necessary tools installed on your computer, you're ready to start the tutorial, and can skip ahead to the link:/learn/tutorials/java-web-app-tutorial/running-and-debugging-maven-apps-in-intellij[next chapter]. If not, follow the instructions for your operating system to get ready to start coding.
