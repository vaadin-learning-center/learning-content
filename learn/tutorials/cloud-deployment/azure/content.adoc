...
----
+
. Add the details of your Azure Web App to the `pom.xml`:
+
.`*pom.xml*`
[source,xml]
----
...
You can view the example application running from GitHub link:https://newbranchtest2.azurewebsites.net/[here].

Source code: https://github.com/Mikaelsu/vaadin-demo-app