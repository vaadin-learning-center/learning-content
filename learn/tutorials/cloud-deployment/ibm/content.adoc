...
For more information on this, please read step 4.
...
NOTE: For Oauth login you need to use:  `cf login -a *the_endpoint_address* -sso` and follow instructions.
...
. Right-click on open “Git” tool in a new tab and follow instructions.
. After pushing your project, return to the tab of your toolchain and click on the “Delivery Pipeline” tool. You will need to create a new “Stage”.
...
After successful deployment when you click on “View console” you will be forwarded to deployment page of the application, where you can check it’s status:
