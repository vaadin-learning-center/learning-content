...
A following excellent step would be, to https://vaadin.com/learn/tutorials/cloud-deployment/kubernetes[deploy your Java application on a Kubernetes container] for actual production.
