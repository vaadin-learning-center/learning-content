...
First, we must deploy the web component as a WebJar, as explained in the second section of https://vaadin.com/learn/tutorials/using-web-components-in-java[using web components in java] tutorial.
...
Extract and open the Maven project in your editor of choice (see here for https://vaadin.com/learn/tutorials/import-maven-project-intellij-idea[IntelliJ], https://vaadin.com/learn/tutorials/import-maven-project-eclipse[Eclipse], or https://vaadin.com/learn/tutorials/import-maven-project-netbeans[Netbeans]). 
