...
:type: text, video
:topic: frontend
:tags: LitElement, redux, state management
:description: Using Redux for state management in a LitElement application
:repo: https://github.com/vaadin-learning-center/lit-element-tutorial-03-state-management-with-redux
:linkattrs:
:imagesdir: ./images
...
https://github.com/learn-vaadin/lit-element-tutorial-02-templating-properties-and-events[Step 2 source code, role="cta"]
...
https://github.com/learn-vaadin/lit-element-tutorial-03-state-management-with-redux[Source code for this tutorial, role="cta"]
