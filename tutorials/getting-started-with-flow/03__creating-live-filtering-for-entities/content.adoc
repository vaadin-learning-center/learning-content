...
In this part of the tutorial we add filtering functionality to the `Customer` listing we created in <<../02__listing-entities-in-a-grid/content.adoc,Listing Entities in a Grid>>.  
