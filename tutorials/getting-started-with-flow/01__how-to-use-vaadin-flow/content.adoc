...
You can get up and running quickly with Flow. You don't need extensive Java knowledge, but you do need basic Java programming skills, some experience using an https://en.wikipedia.org/wiki/Integrated_development_environment[IDE] (like Eclipse) and Maven, and JDK 8 installed on your computer.  
