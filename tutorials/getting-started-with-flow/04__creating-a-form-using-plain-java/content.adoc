...
* http://spring.io/guides/gs/crud-with-vaadin/[Creating CRUD UI with Vaadin] - Check another Vaadin tutorial with Spring Boot and Spring Data JPA backend, allowing you to connect your application to real database.
* https://vaadin.com/tutorials[Vaadin tutorials] - Learn more about Vaadin and integartions to other related technologies.
