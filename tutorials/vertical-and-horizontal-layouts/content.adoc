...
Feel free to test this and play around with the sources that are available in https://github.com/vaadin-learning-center/vertical-horizontal-layouts[this GitHub project].
