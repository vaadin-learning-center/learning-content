= Practical steps to migrate a simple Vaadin 7 application to Vaadin platform
...
:description: Step-by-step guide to migration your application from Vaadin 7 to Vaadin platform
...
For binding a list of beans to the UI component, with the Vaadin platform you use a DataProvider. In the given example the default DataProvider of the grid component is used, which is a simple in-memory DataProvider.
