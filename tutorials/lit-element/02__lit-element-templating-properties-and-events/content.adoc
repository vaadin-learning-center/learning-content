...
https://github.com/learn-vaadin/lit-element-tutorial-starting-a-lit-element-project[Step 1 source, role="cta"]
...
https://github.com/learn-vaadin/lit-element-tutorial-templating-properties-and-events[Browse the finished code on GitHub, role="cta"]
