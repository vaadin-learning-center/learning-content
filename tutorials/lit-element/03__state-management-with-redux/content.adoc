...
https://github.com/learn-vaadin/lit-element-tutorial-templating-properties-and-events[Step 2 source code, role="cta"]
...
https://github.com/learn-vaadin/lit-element-tutorial-state-management-with-redux[Source code for this tutorial, role="cta"]
