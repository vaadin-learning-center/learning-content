...
In this 2 minute tutorial, you will learn how to build a small but fully functional Vaadin application. You will learn the basics of component-based development and listening to events.
