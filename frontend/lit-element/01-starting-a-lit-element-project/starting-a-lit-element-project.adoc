...
:repo: https://github.com/learn-vaadin/lit-element-tutorial-01-starting-a-lit-element-project
:linkattrs:
:imagesdir: ./images
...
https://github.com/learn-vaadin/lit-element-tutorial-00-starter/archive/master.zip[Download LitElement starter, role="cta"]
